...
export default function Navbar() {
    ...
    return (
        ...
        <div className='logoImg flex flex-row gap-1 font-extrabold text-4xl '>
            <p className='text-[#ffde59]'>&lt;</p> <p>Arpit</p> <p className='text-[#5e17eb]'>Jha</p>  <p className='text-[#ffde59]'>/&gt;</p>
        </div>
        {/* Menu */}
        <div className='menuOptions  hidden md:flex'>
            ...
            {/* Mobile menu */}
            {nav && <div className='absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center'>
                <ul>
                    <li className='py-6 text-4xl'>
                        <Link onClick={toggleNav}  to="home"  smooth={true} offset={50} duration={500} >
                            Home
                        </Link>
                    </li>
                    <li className='py-6 text-4xl'>
                        <Link onClick={toggleNav} to="about"  smooth={true} offset={50} duration={500} >
                            About
                        </Link>
                    </li>
                    <li className='py-6 text-4xl'>
                        <Link onClick={toggleNav} to="skills"  smooth={true} offset={50} duration={500} >
                            Skills
                        </Link>
                    </li>
                    <li className='py-6 text-4xl'>
                        <Link onClick={toggleNav} to="projects"  smooth={true} offset={50} duration={500} >
                            Projects
                        </Link>
                    </li>
                    <li className='py-6 text-4xl'>
                        <Link onClick={toggleNav} to="contact"  smooth={true} offset={50} duration={500} >
                            Contact
                        </Link>    
                    </li> 
                </ul>
            ...
            <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul>
                    <li className='w-[180px] h-[40px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#0A63BC]'>
                        <a className='flex justify-evenly items-center w-full text-gray-300' href="https://www.linkedin.com/in/arpit-jha-385ba4190/" target='_blank'>LinkedIn <FaLinkedin size={30}/></a>
                    </li>
                    <li className='w-[180px] h-[40px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#161B22]'>
                        <a className='flex justify-evenly items-center w-full text-gray-300' href="https://github.com/arpitjha867" target='_blank'>Github <FaGithub size={30}/></a>
                    </li>
